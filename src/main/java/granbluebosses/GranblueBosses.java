...
import granbluebosses.intents.*;
import granbluebosses.relics.*;
import granbluebosses.rewards.CustomRewardEnums;
...
import granbluebosses.util.primalcards.PrimalUtils;
...
public class GranblueBosses implements
    ...
    public static Act1Skies act1Skies = null;
    public static Act2Arcarum act2Arcarum = null;
    ...
    public static void initialize() {
        ...
        PrimalUtils.registerPrimalColor();
    }
    ...
    // TODO IMPORTANT :
    /* Add (Cannot Dispel) text to string of BOSS_MECHANIC powers
    ...
    * */
    ...
    public void receivePostInitialize() {
        ...
        SignatureHelper.registerEasyUnlock(new ZArcarumEasyUnlock());
        CustomIntent.add(new InstaKillIntent());
        CustomIntent.add(new MagicDamageIntent());
        CustomIntent.add(new SetHealthIntent());
        CustomIntent.add(new AttackPlusMagicIntent());

        //Act 1 Prep
        Act1Skies.defineMonsters();
        Act1Skies.addEvents();

        act1Skies  = new Act1Skies();

        CustomDungeon.addAct(1, act1Skies);

        //Act 2 Prep
        Act2Arcarum.defineMonsters();
        Act2Arcarum.addEvents();

        act2Arcarum  = new Act2Arcarum();

        CustomDungeon.addAct(2, act2Arcarum);

        //If you want to set up a config panel, that will be done here.
        //You can find information about this on the BaseMod wiki page "Mod Config and Panel".
        BaseMod.registerCustomReward(
                CustomRewardEnums.GOLD_BRICK,
                (rewardSave) -> { // this handles what to do when this quest type is loaded.
                    return new GoldBrickReward();
                },
    ...
    public static String intentPath(String file) {return resourcesFolder + "/images/ui/intents/" + file;}
    public static String videoPath(String file) {
        return resourcesFolder + "/video/" + file;
    }
    public static String yatimaPath(String file) {
        return resourcesFolder + "/images/characters/yatima/" + file;
    }
        ...
        new AutoAdd(modID) //Loads files from this mod
                ...
                .any(BaseRelic.class, (info, relic) -> { //Run this code for any classes that extend this class
                    if (relic.pool != null)
                        ...
                        BaseMod.addRelic(relic, RelicType.SHARED); //Register a shared or base game character specific relic
    ...
    public void receiveEditCards() {
        ...
        HashSet<String> lockedCardIDs = new HashSet<>();

        lockedCardIDs.add(ParadiseLostCard.ID);
        lockedCardIDs.add(ChaosLegionCard.ID);

        new AutoAdd(modID) //Loads files from this mod
                .packageFilter(BaseCard.class) //In the same package as this class
                .any(AbstractCard.class, (info, card) -> {
                    BaseMod.addCard(card);
                    if (info.seen || !lockedCardIDs.contains(card.cardID)) {
