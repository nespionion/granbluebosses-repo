...
public class OdiousPapahlukruvaCard extends BaseCard {

    public static final String ID = makeID(OdiousPapahlukruvaCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DamageAction(p, new DamageInfo(p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.FIRE));
        for (AbstractMonster mo : AbstractDungeon.getMonsters().monsters){
            if (mo.hasPower(ArtifactPower.POWER_ID)) addToBot(new RemoveSpecificPowerAction(mo, p, mo.getPower(ArtifactPower.POWER_ID)));
        }
    }
