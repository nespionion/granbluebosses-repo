...
public class OdiousZamalvochCard extends BaseCard {

    public static final String ID = makeID(OdiousZamalvochCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DamageAction(p, new DamageInfo(p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.NONE));
