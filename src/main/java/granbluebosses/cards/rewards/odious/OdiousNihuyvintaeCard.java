...
public class OdiousNihuyvintaeCard extends BaseCard {

    public static final String ID = makeID(OdiousNihuyvintaeCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new DamageAllEnemiesAction(p, this.damage, this.damageTypeForTurn, AbstractGameAction.AttackEffect.POISON));
        addToBot(new DamageAction(p, new DamageInfo(p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.POISON));
        for (AbstractMonster mo : AbstractDungeon.getMonsters().monsters){
            if (AbstractDungeon.cardRng.randomBoolean()){
                addToBot(new ApplyPowerAction(mo, p, new ATKDown(mo, this.magicNumber)));
            } else {
                addToBot(new ApplyPowerAction(mo, p, new DEFDown(mo, this.magicNumber)));
            }
        }
    }
