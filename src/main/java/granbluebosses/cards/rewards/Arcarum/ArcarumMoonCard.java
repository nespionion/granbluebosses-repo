...
public class ArcarumMoonCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumMoonCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new MoonCrescent(p)));
