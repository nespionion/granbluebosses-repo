...
import granbluebosses.powers.cards.DoubleStrike;
...
public class ArcarumSunCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumSunCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new DoubleStrike(p, this.magicNumber), this.magicNumber));
