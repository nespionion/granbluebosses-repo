...
public class ArcarumDevilCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumDevilCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, p, new ATKDown(m, this.magicNumber, false), this.magicNumber));
        addToBot(new ApplyPowerAction(m, p, new DEFDown(m, this.magicNumber, false), this.magicNumber));
