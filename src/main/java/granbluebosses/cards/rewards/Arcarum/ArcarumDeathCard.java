...
public class ArcarumDeathCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumDeathCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ExhaustAction(Math.max(1, p.hand.size() - this.magicNumber), true, false, false));
