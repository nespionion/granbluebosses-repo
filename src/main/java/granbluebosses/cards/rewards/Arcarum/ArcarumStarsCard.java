...
import granbluebosses.powers.cards.ImpregnableFortress;
...
public class ArcarumStarsCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumStarsCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new ImpregnableFortress(p, this.magicNumber), this.magicNumber));
