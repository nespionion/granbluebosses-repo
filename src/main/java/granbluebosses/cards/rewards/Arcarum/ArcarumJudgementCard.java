...
import granbluebosses.powers.cards.SentencedTrumpet;
...
public class ArcarumJudgementCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumJudgementCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new SentencedTrumpet(p, 2, this.magicNumber), 2));
