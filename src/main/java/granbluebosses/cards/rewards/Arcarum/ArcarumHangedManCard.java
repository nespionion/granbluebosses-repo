...
public class ArcarumHangedManCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumHangedManCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new CleanseDebuffAction(p, p, 1));
        ...
        } else if (AbstractDungeon.cardRng.randomBoolean()) {
            addToBot(new ApplyPowerAction(p, p, new StrengthPower(p, this.magicNumber), this.magicNumber));
            addToBot(new ApplyPowerAction(p, p, new LoseStrengthPower(p, this.magicNumber), this.magicNumber));
        } else {
            addToBot(new ApplyPowerAction(p, p, new DexterityPower(p, this.magicNumber), this.magicNumber));
