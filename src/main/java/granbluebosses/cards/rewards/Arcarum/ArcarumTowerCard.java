...
import granbluebosses.powers.cards.ThunderboltOfDisaster;
...
public class ArcarumTowerCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumTowerCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new ThunderboltOfDisaster(p, this.magicNumber), this.magicNumber));
