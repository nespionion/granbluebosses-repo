...
public class ArcarumTemperanceCard extends BaseSignatureCard {

    public static final String ID = makeID(ArcarumTemperanceCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.damage = (int)(this.baseDamage * (1 + Math.abs(0.5 - ((float)p.currentHealth / (float)p.maxHealth))));
