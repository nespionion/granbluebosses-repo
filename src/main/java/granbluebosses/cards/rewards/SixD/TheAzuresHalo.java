...
import granbluebosses.powers.common.DEFUp;
...
public class TheAzuresHalo extends BaseCard {

    public static final String ID = makeID(TheAzuresHalo.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        addToBot(new ApplyPowerAction(p, p, new PhalanxPower(p, 100), 100));
