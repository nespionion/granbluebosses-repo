...
import granbluebosses.powers.cards.TheEmeraldsWindfallPower;
...
public class TheEmeraldsWindfall extends BaseCard {

    public static final String ID = makeID(TheEmeraldsWindfall.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player,AbstractDungeon.player, new TheEmeraldsWindfallPower(AbstractDungeon.player, this.magicNumber), this.magicNumber));
    }
