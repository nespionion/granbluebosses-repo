...
import granbluebosses.powers.cards.TheBlacksEncroachmentPower;
...
public class TheBlacksEncroachment extends BaseCard {

    public static final String ID = makeID(TheBlacksEncroachment.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player,AbstractDungeon.player, new TheBlacksEncroachmentPower(AbstractDungeon.player, this.magicNumber), this.magicNumber));
    }
