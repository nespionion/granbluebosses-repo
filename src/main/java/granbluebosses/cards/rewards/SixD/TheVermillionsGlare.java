...
public class TheVermillionsGlare extends BaseCard {

    public static final String ID = makeID(TheVermillionsGlare.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player,AbstractDungeon.player, new DoubleDamagePower(AbstractDungeon.player, 1, false), 1));
