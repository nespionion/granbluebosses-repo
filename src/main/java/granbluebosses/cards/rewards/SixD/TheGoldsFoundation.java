...
import granbluebosses.powers.cards.TheGoldsFoundationPower;
...
public class TheGoldsFoundation extends BaseCard {

    public static final String ID = makeID(TheGoldsFoundation.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        addToBot(new ApplyPowerAction(p, p, new TheGoldsFoundationPower(p, this.magicNumber), this.magicNumber));
