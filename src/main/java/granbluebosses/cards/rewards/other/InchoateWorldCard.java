package granbluebosses.cards.rewards.other;
...
import granbluebosses.action.UpgradeAllArcarumCardsAction;
...
public class InchoateWorldCard extends BaseSignatureCard {

    public static final String ID = makeID(InchoateWorldCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new DamageAction(m, new DamageInfo(p, this.damageUpgrade, this.damageTypeForTurn), AbstractGameAction.AttackEffect.SLASH_HEAVY));
        addToBot(new DamageAction(m, new DamageInfo(p, this.damageUpgrade, DamageInfo.DamageType.HP_LOSS), AbstractGameAction.AttackEffect.FIRE));

        if (this.upgraded){
            addToBot(new UpgradeAllArcarumCardsAction());
        }
    }
