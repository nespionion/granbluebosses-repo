...
public class PrometheusCall extends BaseCard {

    public static final String ID = makeID(PrometheusCall.class.getSimpleName());
    ...
    public void render(SpriteBatch sb) {
        if (ConfigMenu.modestyFilter){
            String img = getCardTextureString(removePrefix(makeID("PrometheusCallCen")), this.type);
            this.textureImg = img;
            if (img != null) {
