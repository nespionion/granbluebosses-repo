...
public class CaOngCall extends BaseCard {

    public static final String ID = makeID(CaOngCall.class.getSimpleName());
    ...
    private static final int MAGIC_NUMBER = 35;
    private static final int UPG_MAGIC_NUMBER = 15;
