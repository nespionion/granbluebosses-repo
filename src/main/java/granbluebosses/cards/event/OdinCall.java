...
public class OdinCall extends BaseCard {

    public static final String ID = makeID(OdinCall.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (AbstractDungeon.actionManager.cardsPlayedThisTurn.stream().filter(c -> c.type == CardType.ATTACK).count() > 2){
