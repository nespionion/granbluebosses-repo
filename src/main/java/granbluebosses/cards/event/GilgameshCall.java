...
public class GilgameshCall extends BaseCard {

    public static final String ID = makeID(GilgameshCall.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard card = p.drawPile.getRandomCard(CardType.ATTACK, AbstractDungeon.cardRng.randomBoolean());

        if (card == null || m.isDeadOrEscaped() || m.isDying || m.isEscaping) return;
