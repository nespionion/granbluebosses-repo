...
public class IncantedOmenDeprecated extends BasePower {
    ...
    public IncantedOmenDeprecated(AbstractCreature owner, int amount, OMEN_TYPE omenType) {
        this(owner, amount, omenType, AbstractCard.CardRarity.COMMON);
    }

    public IncantedOmenDeprecated(AbstractCreature owner, int amount, OMEN_TYPE omenType, AbstractCard.CardRarity rarity) {
