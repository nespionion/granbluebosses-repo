...
public class IncantedOmen_deprecated extends BasePower {
    ...
    public IncantedOmen_deprecated(AbstractCreature owner, int amount, OMEN_TYPE omenType) {
        this(owner, amount, omenType, AbstractCard.CardRarity.COMMON);
    }

    public IncantedOmen_deprecated(AbstractCreature owner, int amount, OMEN_TYPE omenType, AbstractCard.CardRarity rarity) {
