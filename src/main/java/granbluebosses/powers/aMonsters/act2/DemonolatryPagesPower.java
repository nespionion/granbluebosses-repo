...
public class DemonolatryPagesPower extends BasePower implements OnOmenCanceledPower {

    public static final String NAME = DemonolatryPagesPower.class.getSimpleName();
    ...
    public DemonolatryPagesPower(AbstractCreature owner, int amount) {
    ...
    private void loadSprites() {
        String unPrefixed = "DemonolatryPagesPower1";
        if (this.amount == 1 || this.amount == 2 || this.amount == 3 || this.amount == 4 || this.amount == 5){
            unPrefixed = "DemonolatryPagesPower" + this.amount;
        }
