...
public class DEFDown extends BasePower {

    public static final String NAME = DEFDown.class.getSimpleName();
    ...
    public DEFDown(AbstractCreature owner, int amount) {
        this(owner, amount, true);
    }

    public DEFDown(AbstractCreature owner, int amount, boolean stayForOneMoreTurn) {
    ...
    public float atDamageReceive(float damage, DamageInfo.DamageType type) {
        return type == DamageInfo.DamageType.NORMAL ? damage * (1.0f - ((float)(this.amount) / 100.0f)) : damage;
    }
