...
public class GoldSlime extends CustomMonster {
    protected static final String MONSTER_NAME = "GoldSlime";
    public static final String MONSTER_ID = makeID("GoldSlime");
    ...
    public void die() {
        if (ConfigMenu.enableExtraRewards && !this.escaped) {
            ...
            RewardItem reward = new RewardItem(this.goldReward);
