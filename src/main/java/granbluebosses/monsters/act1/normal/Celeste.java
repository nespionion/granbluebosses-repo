...
public class Celeste extends CustomMonster {
    ...
    protected void prepareIntent() {
        switch (this.nextMove){
            case 0:
                ...
                break;
            case 1:
                addToBot(new SetMoveAction(this, TRANQUIL_FOG, (byte)0, Intent.ATTACK_DEBUFF, this.damage.get(0).base, 1, false));
                break;
        }
    }
    ...
    protected void getMove(int i) {
        if (this.firstTurn) {
            ...
            this.setMove(TRANQUIL_FOG, (byte)0, Intent.ATTACK_DEBUFF, this.damage.get(0).base, 1, false);
        }
    }
