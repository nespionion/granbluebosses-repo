...
public class AnimaTiamat extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaTiamat");

    public static final BaseCard cardToReceive = new TiamatOmega();
