...
public class AnimaGrimnir extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaGrimnir");

    public static final BaseCard cardToReceive = new GrimnirCall();
