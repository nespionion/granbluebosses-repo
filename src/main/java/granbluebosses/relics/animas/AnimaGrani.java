...
import granbluebosses.cards.rewards.GraniCall;
import granbluebosses.relics.BaseRelic;

public class AnimaGrani extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaGrani");

    public static final BaseCard cardToReceive = new GraniCall();
