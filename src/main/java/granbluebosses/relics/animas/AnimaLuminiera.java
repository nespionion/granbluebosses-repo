...
public class AnimaLuminiera extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaLuminiera");

    public static final BaseCard cardToReceive = new LuminieraOmega();
    private boolean cardsReceived = true;

    public AnimaLuminiera() {
        super(
                RELIC_ID,       // ID
                "AnimaLuminiera",
