...
public class AnimaEuropa extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaEuropa");

    public static final BaseCard cardToReceive = new EuropaCall();
