...
import granbluebosses.cards.rewards.BaalCall;
import granbluebosses.monsters.act1.normal.Baal;
import granbluebosses.relics.BaseRelic;

public class AnimaBaal extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaBaal");

    public static final BaseCard cardToReceive = new BaalCall();
