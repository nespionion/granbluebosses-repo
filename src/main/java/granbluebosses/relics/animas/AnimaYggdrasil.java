...
public class AnimaYggdrasil extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaYggdrasil");

    public static final BaseCard cardToReceive = new YggdrasilOmega();
    private boolean cardsReceived = true;

    public AnimaYggdrasil() {
        super(
                RELIC_ID,       // ID
                "AnimaYggdrasil",
