...
import granbluebosses.cards.rewards.GarudaCall;
import granbluebosses.relics.BaseRelic;

public class AnimaGaruda extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaGaruda");

    public static final BaseCard cardToReceive = new GarudaCall();
