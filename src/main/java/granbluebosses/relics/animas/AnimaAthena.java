...
import granbluebosses.cards.rewards.AthenaCall;
import granbluebosses.relics.BaseRelic;

public class AnimaAthena extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaAthena");

    public static final BaseCard cardToReceive = new AthenaCall();
