...
public class AnimaLeviathan extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaLeviathan");

    public static final BaseCard cardToReceive = new LeviathanOmega();
    private boolean cardsReceived = true;

    public AnimaLeviathan() {
        super(
                RELIC_ID,       // ID
                "AnimaLeviathan",
