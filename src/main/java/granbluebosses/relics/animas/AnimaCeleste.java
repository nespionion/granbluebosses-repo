...
public class AnimaCeleste extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaCeleste");

    public static final BaseCard cardToReceive = new CelesteOmega();
