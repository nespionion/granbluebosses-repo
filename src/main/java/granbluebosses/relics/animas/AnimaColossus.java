...
public class AnimaColossus extends BaseRelic {

    public static final String RELIC_ID = GranblueBosses.makeID("AnimaColossus");

    public static final BaseCard cardToReceive = new ColossusOmega();
    private boolean cardsReceived = true;

    public AnimaColossus() {
        super(
                RELIC_ID,       // ID
                "AnimaColossus",
