...
public class WorldforgingMorosRelic extends BaseRelic {
    public static final String NAME = "WorldforgingMorosRelic"; //The name will be used for determining the image file as well as the ID.
    ...
    public float atDamageModify(float damage, AbstractCard c) {
        return c.rarity == AbstractCard.CardRarity.RARE && c.type == AbstractCard.CardType.ATTACK ?
                super.atDamageModify(damage, c) * 1.2f :
    ...
    public AbstractRelic makeCopy() {
        return new WorldforgingMorosRelic();
    }
}
