...
import static granbluebosses.intents.enums.CustomIntentEnums.SET_PLAYER_HP;

public class SetHealthIntent extends CustomIntent {
     ...
     */
    public SetHealthIntent() {
        super(SET_PLAYER_HP, TEXT[0],
                intentPath("SetHealthIntent.png"), //These are just the paths to my images.
                intentPath("SetHealthIntentL.png"),  //Will differ for yours, of course.
                TEXT[1]);
        GranblueBosses.logger.info("Intent Img path: " + intentPath("SetHealthIntent.png"));
    }
    ...
    public String damageNumber(AbstractMonster am) {
        return am instanceof HasSetHPMove ? ((HasSetHPMove)am).getSetHPAmountString() : "-1";
    }
...
//    }
    ...
    */
    ...
    static {
        ID = makeID(SetHealthIntent.class.getSimpleName());
