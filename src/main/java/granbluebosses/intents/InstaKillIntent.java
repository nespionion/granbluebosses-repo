...
import static granbluebosses.intents.enums.CustomIntentEnums.INSTAKILL;

public class InstaKillIntent extends CustomIntent {
     ...
     */
    public InstaKillIntent() {
        super(INSTAKILL, TEXT[0],
                GranblueBosses.intentPath("InstaKillIntent.png"), //These are just the paths to my images.
...
//    }
    ...
    */
    ...
    static {
        ID = makeID(InstaKillIntent.class.getSimpleName());
